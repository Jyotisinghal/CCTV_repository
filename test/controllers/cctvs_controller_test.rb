...
class CctvsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cctv" do
    assert_difference('Cctv.count') do
      post cctvs_url, params: { cctv: { brand: @cctv.brand, category: @cctv.category, model: @cctv.model, price: @cctv.price } }
    end
  ...
  test "should update cctv" do
    patch cctv_url(@cctv), params: { cctv: { brand: @cctv.brand, category: @cctv.category, model: @cctv.model, price: @cctv.price } }
